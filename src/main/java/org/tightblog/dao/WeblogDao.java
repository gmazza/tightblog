...
public interface WeblogDao extends JpaRepository<Weblog, String> {
    ...
    Weblog findByHandleAndVisible(String handle, boolean visible);

    // Default method to accommodate Derby dialect during
    // integration tests. Derby does not support 'AND boolean'
    // generated by Hibernate for 'AND visible = true' query.
    default Weblog findByHandleAndVisibleTrue(String handle) {
        return findByHandleAndVisible(handle, true);
    }
