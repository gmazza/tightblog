...
limitations under the License. For additional information regarding copyright in
this work, please see the NOTICE file in the top level directory of this
distribution. --%> <%@ include file="/WEB-INF/jsps/tightblog-taglibs.jsp" %>
    ...
    <tr>
      <td class="bannerLeft">
        ...
        <c:if test="${authenticatedUser != null}">
          ...
          <c:out value="${authenticatedUser.screenName}" />
        </c:if>

        <c:if test="${actionWeblog != null}">
          - <fmt:message key="mainPage.currentWebsite" />
          <b
            ><a href='<c:out value="${actionWeblogURL}" />'>
              <c:out value="${actionWeblog.handle}" /> </a
          ></b>
        </c:if>
      </td>
      ...
      <td class="bannerRight">
        <c:choose>
          <c:when test="${authenticatedUser != null}">
            ...
            <a href="<c:url value='/tb-ui/app/home'/>"
            ...
            /></a>
            |
            <a href="<c:url value='/tb-ui/app/logout'/>"
          ...
          <c:otherwise>
            <a href="<c:url value='/'/>"
              ><fmt:message key="navigationBar.homePage"
            /></a>
            |
            <a href="<c:url value='/tb-ui/app/login-redirect'/>"
